import  React, { useState, useEffect } from "react";
  ...
  function App() {
    ...
    const fetchTasks = async () => {
      try {
        const response = await axios.get("https://inventory-zh0h.onrender.com/fetched");
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      try {
        await axios.post("https://inventory-zh0h.onrender.com/create", newTask);
    ...
    const handleDelete = async (id) => {
      try {
        await axios.delete(`https://inventory-zh0h.onrender.com/delete/${id}`);
        fetchTasks();
      } catch (error) {
    ...
    const handleUpdate = async (id) => {
      try {
        await axios.put(`https://inventory-zh0h.onrender.com/update/${id}`, editTask);
